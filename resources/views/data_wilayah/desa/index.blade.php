        ...
        <div class="row same-height">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" class="mb-3 btn btn-primary btn-add">Tambah Desa</button>
                        {{ $dataTable->table() }}
                    </div>
                </div>
            </div>
...
@push('js')
    ...
    <script>
        ...
        //editDesa
        $('#desa-table').on('click','.action', function(){
            let data = $(this).data()
            let id = data.id

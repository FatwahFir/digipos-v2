...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <head>
        ...
        <title>DigiPosyandu - Forgot Password</title>
        <!-- Icons-->
    ...
    <body class="app flex-row align-items-center">
        ...
        <div class="area" >
            ...
            <form method="POST" action="{{ route('check_lupa_password') }}">@csrf
                            ...
                            <div class="card-group">
                                <div class="card p-4">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">Change your old password</p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-right">
												...
												<a href="{{ route('login') }}" class="btn btn-link px-0">Back</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

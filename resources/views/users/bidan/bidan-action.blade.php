<div class="modal-content">
    <form id="formAction" action="{{ $user->id ? route('bidan.update', $user->id):route('bidan.store') }}" method="POST">
        @csrf
        @if ($user->id)
            @method('put')
        @endif
    ...
    <div class="modal-body">
        <div class="mb-3">
            ...
            <input type="text" placeholder="Nama.." value="{{ $user->id ? $user->bidan->nama : ''}}" name="name" class="form-control" id="name">
        </div>
        <div class="mb-3">
